...
class MainActivity : AppCompatActivity(), ForecastAdapter.ForecastAdapterOnItemClickHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val factory = MainViewModelFactory(InjectorUtils.provideRepository(this))

        mViewModel = ViewModelProviders.of(this, factory).get(MainViewModel::class.java)

        // Create the observer which updates the UI.
        val forecastObserver = Observer<List<ListViewWeatherEntry>> { weatherEntries ->
        ...
        mViewModel!!.forecast.observe(this,forecastObserver)
